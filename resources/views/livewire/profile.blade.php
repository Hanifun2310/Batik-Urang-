                ...
                <div class="p-6 space-y-4">
                    ...
                    <div>
                        ...
                        <div class="mt-1 flex items-center space-x-5">
                            ...
                            <div>
                                <label for="photo"
                                    class="cursor-pointer bg-white py-2 px-3 border border-gray-300 rounded-md shadow-sm text-sm leading-4 font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-amber-500">
                                    <span>Ganti Foto</span>
                                    <input id="photo" name="photo" type="file" class="sr-only"
                                        wire:model="photo">
                                </label>
                                <div wire:loading wire:target="photo" class="mt-1 text-xs text-gray-500">Mengupload...
                                </div>
                            </div>
                        </div>
                        @error('photo')
                            <span class="text-red-500 text-sm mt-2">{{ $message }}</span>
                        @enderror {{-- Tambah margin atas --}}
                    </div>
                    ...
                    <div>
                        ...
                        <p class="mt-1 text-sm text-gray-700">
                            {{ Auth::user()->created_at->translatedFormat('l, d F Y') }}</p>
                    </div>
