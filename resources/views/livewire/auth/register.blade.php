        ...
        <div class="w-full max-w-md">
            <div class="bg-white rounded-lg shadow-2xl overflow-hidden">
                ...
                <div class="px-6 py-8">
                    <form wire:submit="register" class="space-y-5">
                        ...
                        <div x-data="{ showPassword: false }">
                            ...
                            <div class="relative">
                                ...
                                <button type="button" @click="showPassword = !showPassword"
                                    class="absolute inset-y-0 right-0 pr-3 flex items-center text-gray-600 hover:text-amber-700">
                        ...
                        <!-- Tombol Daftar -->
                        <button type="submit"
                            class="w-full bg-gradient-to-r from-amber-600 to-orange-600 text-white font-bold py-3 rounded-lg hover:from-amber-700 hover:to-orange-700 transition-all duration-200 transform hover:scale-105 active:scale-95 mt-4">
                    ...
                    <div class="relative my-6">
                        ...
                        <div class="relative flex justify-center text-sm"><span
                                class="px-2 bg-white text-gray-500">atau</span></div>
                    </div>
                </div>
                ...
                <div class="bg-gray-50 px-6 py-4 text-center border-t border-gray-200">
                    <p class="text-gray-700 text-sm">
                        ...
                        <a href="{{ route('login') }}" wire:navigate
                            class="text-amber-600 hover:text-amber-700 font-bold transition-colors">
                            Masuk di sini
                        </a>
                    </p>
                </div>
            ...
            <div class="text-center mt-6">
                <a href="{{ route('welcome') }}" wire:navigate
                    class="text-amber-700 hover:text-amber-800 font-semibold flex items-center justify-center gap-2 transition-colors">
