    ...
    <section class="relative bg-linear-to-r from-amber-900 to-amber-700 text-white py-16 sm:py-20 overflow-hidden">
        ...
        <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center">
                <h1 class="text-4xl sm:text-5xl lg:text-6xl font-bold mb-4 drop-shadow-lg">Batik</h1>
                <p class="text-lg sm:text-xl lg:text-2xl text-amber-100 mb-6 sm:mb-8 drop-shadow-md">Warisan Budaya
                    Dunia yang Membanggakan</p>
                <p class="text-base sm:text-lg text-amber-50 max-w-2xl mx-auto drop-shadow-md">Dapatkan keindahan dan
                    makna mendalam di balik setiap motif batik di Website kami</p>
            </div>
        </div>
    </section>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mt-12 text-center">
                <a href="{{ route('products.index') }}" wire:navigate
                    class="inline-block bg-amber-800 hover:bg-amber-900 text-white font-semibold py-3 px-8 rounded-lg transition shadow-md">
                    Lihat Semua Koleksi
                </a>
            </div>
        </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="text-center mb-12">
                ...
                <p class="text-gray-600 max-w-2xl mx-auto mt-4">Kami siap membantu Anda. Silakan hubungi kami melalui
                    detail di bawah ini atau kunjungi lokasi kami.</p>
            </div>
            ...
            <div class="max-w-4xl mx-auto bg-gray-50 rounded-lg shadow-xl overflow-hidden">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
                        ...
                        <div class="flex items-start space-x-4">
                            ...
                            <div>
                                ...
                                <p class="text-gray-600">F2FQ+R66, Sukanegara, Kec. Jonggol, Kabupaten Bogor, Jawa Barat
                                    16830</p>
                            </div>
                        </div>
                ...
                <div class="w-full h-64 md:h-80">
                    <iframe
                        src="https://www.google.com/maps/embed?pb=!1m16!1m11!1m3!1d3!2d107.03802113535001!3d-6.5254537675309505!2m2!1f0!2f90!3m2!1i1024!2i768!4f75!3m3!1m2!1s0x2e69bd27c6b9b645%3A0x600dcb86d7b2feb3!2sPoliteknik%20IDN!3m2!1sid!2sid!4v1762991058105!5m2!1sid!2sid"
